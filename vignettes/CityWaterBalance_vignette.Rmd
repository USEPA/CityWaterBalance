...
Choose streamgages to evaluate total inflow and outflow for the AOI.  [NWIS mapper](https://maps.waterdata.usgs.gov/) may be useful here.
...
Look at the streamflow data with plotStreamflow. Gaps can be filled using 
gapfillStreamflow.  When there all time series of flows are complete, use
combineStreamflow (which has an example of this entire process).
